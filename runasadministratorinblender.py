...
commands = [
    ...
    f'"{python_executable}" -m pip install --target "{site_packages_path}" nltk',
    f'"{python_executable}" -m pip install --target "{site_packages_path}" vosk',
    f'"{python_executable}" -m pip install --target "{site_packages_path}" numpy',
]
